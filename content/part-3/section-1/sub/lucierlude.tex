...
re\cancelto{ss}{s}onant\textit{thh\rightarrowff}frequencies of-the-room\par
\inspire{short}
reinfor\cancelto{sss}{s}\xcancel{e} them\cancelto{ss}{s}elve\cancelto{sss}{s}\par
\inspire{long}
so that any \par
\textit{{\small s}ss}\rightarrowemblance of my \cancelto{sss}{s}pee\cancelto{ch\rightarrow shwh}{ch}\par
\inspire{long}
