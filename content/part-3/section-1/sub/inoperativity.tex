...
\img{work}{0.8}{
	This graph displaying the work (arrows) of selves (dots) in community (dots joined by arrows) shows how a teleological approach to community can be understood in relation to the first two models with which databases were design: the hierarchical model and the network model \see{descriptions}.
}{Community as work}
