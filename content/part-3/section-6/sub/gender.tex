...
% SKIN: you might need some refreshers unless you've modified the text so some key words that you are using later are very strongly defined. Even then, when using a term like this after a while you might want to make sure it is clearly used.
...
% This section is really well written. You might need to clear up some things like whether you consider that databases have a gender, and what do you consider the role of gender to be in a database. These are general questions that your text must address explicitly.

% also this whole large section is called the gendered database, but I think this seems to be the end of your gender material?
